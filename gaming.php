...
<body>
    <div class="container mt-4">
        <h1 class="text-center mb-4">Gaming</h1>
        
        <div class="row">
            <?php
            // Requête pour récupérer tous les produits gaming
            $sql = "SELECT * FROM modele WHERE Produits = 'Gaming'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<div class="col-12"><p class="text-center">Aucun produit gaming disponible actuellement.</p></div>';
            }
            ?>
        </div>
    </div>
