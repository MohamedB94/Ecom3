...
<body>
    <div class="container mt-4">
        <h1 class="text-center mb-4">Composants</h1>
        
        <div class="row">
            <?php
            // Requête pour récupérer tous les composants
            $sql = "SELECT * FROM modele WHERE Produits = 'Composant'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<div class="col-12"><p class="text-center">Aucun composant disponible actuellement.</p></div>';
            }
            ?>
        </div>
    </div>
