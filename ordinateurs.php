...
<body>
    <div class="container mt-4">
        <h1 class="text-center mb-4">Ordinateurs</h1>
        
        <div class="row">
            <?php
            // Requête pour récupérer tous les ordinateurs
            $sql = "SELECT * FROM modele WHERE Produits = 'Ordinateur'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<div class="col-12"><p class="text-center">Aucun ordinateur disponible actuellement.</p></div>';
            }
            ?>
        </div>
    </div>
